...
**Final Results**
Three machine learning models (Logistic Regression, Random Forest, and XGBoost) were trained and evaluated using Accuracy, Precision, Recall, F1-score, and ROC-AUC. Random Forest achieved the best overall performance with 0.790338% accuracy and an AUC of 0.91345, making it the selected model for the final solution.
